...
import { Github, ExternalLink, Home, FileText, Bot, X } from 'lucide-react'; // Ícone Smile removido
...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-sm border-b border-secondary-200 relative">
      ...
      {/* Navegação Mobile */}
      {isMenuOpen && (
        <nav className="md:hidden bg-white border-t border-secondary-200">
